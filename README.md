...
本リポジトリは、**全エンジニアが効率的に AI 駆動開発を実践する**ことを目的に、  
CTO 室が Galirage における **AI 駆動開発の標準基盤** として提供するテンプレートです。

---

## Overview

本テンプレートは、**AI 駆動開発を 0→1 で立ち上げるための標準ベース**を提供します。  
プロジェクト開始時に必要なルール・ナレッジ・ガイドラインを初期状態から整備し、  
チーム全体で一貫した AI 駆動開発を実現できるよう支援します。
...
- **既存プロジェクト導入時**：必要な越原 崚のみ導入し、段階的にルールを追加
